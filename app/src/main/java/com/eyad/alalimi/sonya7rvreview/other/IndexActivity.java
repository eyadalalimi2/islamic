...
import com.eyad.alalimi.sonya7rvreview.nbholyquran.TextActivity;
import com.eyad.alalimi.sonya7rvreview.nbnawawi.NawawiyaActivity;
import com.eyad.alalimi.sonya7rvreview.nbsahihboukhari.BukhariActivity;
...
public class IndexActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    public void onItemClick(View view, int position) {
        if (indexId == R.id.cat_albukhari) {
            ...
            IndexActivity.newIntent(this, R.id.cat_fiqh_1, categories.get(position).getTitle(),
            ...
            IndexActivity.newIntent(this, R.id.cat_library_1, categories.get(position).getTitle(),
                    R.drawable.cat_fatawy_color);
        } else if (indexId == R.id.cat_library_1) {
