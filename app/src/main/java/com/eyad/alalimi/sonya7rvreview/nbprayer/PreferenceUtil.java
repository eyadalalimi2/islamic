...
public class PreferenceUtil {
    ...
    public static String getTimezonePref(Context context) {
        return getPreferences(context).getString(context.getString(R.string.pref_city_key),
    ...
    public static int getCalcMethodPref(Context context) {
        String method = getPreferences(context).getString(context.getString(R.string.pref_organization_key),
    ...
    public static int getJuristicMethodPref(Context context) {
        return Integer
                .parseInt(getPreferences(context).getString(context.getString(R.string.pref_asr_madhab_key), "0"));
    }
    ...
    public static int[] getOffsetsPref(Context context) {
        ...
        Log.i("PrayerUtil_Log", "getInstance: " + offsetsStr);
        return offsets;
    }
    // endregion
