...
import com.eyad.alalimi.sonya7rvreview.nbholyquran.QuranIndex;
import com.eyad.alalimi.sonya7rvreview.nbholyquran.QuranPage;
import com.eyad.alalimi.sonya7rvreview.nbholyquran.QuranSearch;
...
public class DBManager extends SQLiteOpenHelper {
    ...
    public List<QuranPage> getQuranPageList() {
        ...
        while (c.moveToNext()) {
            ...
            quranAyaList.add(new QuranPage()
                    ...
                    .setPageAya(page)
                    .setPageRes(ctx.getResources().getIdentifier("page" + page, "drawable", ctx.getPackageName()))
    ...
    public List<String> getM3aniList(int suraNum) {
        ...
        Cursor c = db.rawQuery("SELECT * FROM " + TABLE_QURAN_AYA
                ...
                + "AND " + COL_QURAN_MA3NY + " != ? ", new String[]{String.valueOf(suraNum), ""});
