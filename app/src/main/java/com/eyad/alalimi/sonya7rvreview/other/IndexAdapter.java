...
public class IndexAdapter
    ...
    public IndexAdapter(Context context, List<DefaultIndex> recyclerViewItems, RecyclerView mRecyclerView,
                        int leftImageDrawableResId) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int superPosition) {
        ...
        if (holder instanceof DialogHolder) {
            ...
            // Set the image for iv_row_right using the default drawable resource ID from
            // XML
