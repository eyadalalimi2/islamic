...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setPositiveButton(mContext.getResources().getString(R.string.settings_button_ok),
        ...
        alertDialog.setNegativeButton(mContext.getResources().getString(R.string.settings_button_cancel),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                    }
