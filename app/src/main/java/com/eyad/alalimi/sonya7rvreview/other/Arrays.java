...
import com.eyad.alalimi.sonya7rvreview.nbsahihboukhari.DefaultIndex;
...
public class Arrays {
    ...
    public static List<Category> getQuranItemList() {
        ...
        categories
                .add(new Category().setCategoryId(R.id.cat_quran_item_tafsir).setTitle(R.string.cat_quran_item_tafsir));
    ...
    public static List<Category> getQuranOptions() {
        ...
        categories.add(new Category().setCategoryId(R.id.cat_quran_item_read_virtue)
                .setTitle(R.string.cat_quran_item_read_virtue));
        categories.add(new Category().setCategoryId(R.id.cat_quran_item_doaa).setTitle(R.string.cat_quran_item_doaa));
        categories
                .add(new Category().setCategoryId(R.id.cat_quran_item_tafsir).setTitle(R.string.cat_quran_item_tafsir));
        categories.add(new Category().setCategoryId(R.id.cat_quran_item_m3ani).setTitle(R.string.cat_quran_item_m3ani));
        categories.add(new Category().setCategoryId(R.id.cat_quran_item_save_mark)
                .setTitle(R.string.cat_quran_item_save_mark));
        categories.add(
                new Category().setCategoryId(R.id.cat_quran_item_go_mark).setTitle(R.string.cat_quran_item_go_mark));
        return categories;
    }
