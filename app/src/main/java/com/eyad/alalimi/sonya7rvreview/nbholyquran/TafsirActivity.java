...
public class TafsirActivity extends AppCompatActivity {
    ...
    private Spinner sprTafsierBook, sprTafsierSura, sprTafsierAya;
    ...
    private int suraNum = 1, selectedTafsir;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sprTafsierBook = findViewById(R.id.spr_tafsier_book);
        ...
        suraTafsirList = DBManager.getInstance(this).getTafsirList(suraNum, selectedTafsir);
    ...
    private void initSpinnerListener() {
        sprTafsierBook.setOnItemSelectedListener(new SpinnerListener() {
            @Override
            public void onItemSelected(int position) {
                selectedTafsir = position;
                suraTafsirList = DBManager.getInstance(TafsirActivity.this).getTafsirList(suraNum, selectedTafsir);
