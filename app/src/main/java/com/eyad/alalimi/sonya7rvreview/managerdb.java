...
import static com.eyad.alalimi.sonya7rvreview.AyaList.isConnectingToInternet;
...
public class managerdb extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnectingToInternet(managerdb.this)) {
            ...
            Toast.makeText(this, "لايوجد انصال بالانترنت تاكد ان الانترنت شغال لديك ........", Toast.LENGTH_SHORT)
                    .show();
