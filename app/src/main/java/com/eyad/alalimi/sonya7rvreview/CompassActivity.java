...
public class CompassActivity extends AppCompatActivity {
    ...
    public void getBearing() {
        ...
        if (kiblat_derajat > 0.0001) {
            text_bawah.setText(getResources().getString(R.string.your_location) + " "
                    + getResources().getString(R.string.using_last_location));
            text_atas.setText(getResources().getString(R.string.qibla_direction) + " " + kiblat_derajat + " "
            ...
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(getApplicationContext(),
                            getResources().getString(R.string.toast_permission_required), Toast.LENGTH_LONG).show();
                    finish();
                }
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // this.menu = menu;
        // menu.getItem(0). setIcon(ContextCompat.getDrawable(getApplicationContext(),
        // R.drawable.gps_off));
    ...
    public void fetch_GPS() {
        ...
        if (gps.canGetLocation()) {
            ...
            if (lat_saya < 0.001 && lon_saya < 0.001) {
                ...
                // Toast.makeText(getApplicationContext(), "Location not ready, Please Restart
                // Application", Toast.LENGTH_LONG).show();
            } else {
                if (item != null) {
                    item.setIcon(ContextCompat.getDrawable(getApplicationContext(), R.drawable.gps_on));
                }
                double longitude2 = 39.826206; // ka'bah Position
                // https://www.latlong.net/place/kaaba-mecca-saudi-arabia-12639.html
                double longitude1 = lon_saya;
                double latitude2 = Math.toRadians(21.422487); // ka'bah Position
                // https://www.latlong.net/place/kaaba-mecca-saudi-arabia-12639.html
                ...
                text_atas.setText(getResources().getString(R.string.qibla_direction) + " " + result2 + " "
                        + getResources().getString(R.string.degree_from_north));
                Toast.makeText(getApplicationContext(), getResources().getString(R.string.qibla_direction) + " "
                                + result2 + " " + getResources().getString(R.string.degree_from_north), Toast.LENGTH_LONG)
                        .show();
                arrowViewQiblat.setVisibility(View.VISIBLE);

            }
            // Toast.makeText(getApplicationContext(), "lat_saya: "+lat_saya + "\nlon_saya:
            // "+lon_saya, Toast.LENGTH_LONG).show();
        } else {
            // can't get location
            ...
            // Toast.makeText(getApplicationContext(), "Please enable Location first and
