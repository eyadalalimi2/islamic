...
import com.eyad.alalimi.sonya7rvreview.MainActivityFist;
import com.eyad.alalimi.sonya7rvreview.R;
import com.eyad.alalimi.sonya7rvreview.nbprayer.AssetsProvider;
...
public class UtilNotif {
    ...
    public static Uri getRawUri(Context context, String filename) {
        return Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + File.pathSeparator + File.separator
                + context.getPackageName() + "/raw/" + filename);
    }
    ...
    public static void newAthanNotification(Context context) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, ANDROID_ATHAN_CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_launcher)
                .setContentTitle(context.getString(R.string.app_name))
                .setContentText(message);
