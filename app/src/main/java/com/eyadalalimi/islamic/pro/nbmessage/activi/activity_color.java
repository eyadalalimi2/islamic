...
public class activity_color extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        white = findViewById(R.id.black);
        pink = findViewById(R.id.pink);
        brown = findViewById(R.id.broiwn);
        green = findViewById(R.id.geen);
        blu = findViewById(R.id.darkslateblue);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.aqua) {
            ...
            setResult(RESULT_OK, intent);
            finish();
        } else if (id == R.id.darkslateblue) {
            intent = new Intent();
            intent.putExtra("color", "#483D8B");
            setResult(RESULT_OK, intent);
            finish();
        } else if (id == R.id.geen) {
            intent = new Intent();
