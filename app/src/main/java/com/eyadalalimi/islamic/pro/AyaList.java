...
//get list of muslim
        ...
        if(!isConnectingToInternet(AyaList.this))
        {
            ...
            builder1.setMessage("يجب الإتصال بالإنترنت لكي تعمل جميع وظائف هذه الصفحة بدون مشاكل أو تحميل السور و الإستماع لها بدون إنترنت ، حيث يمكنك الأن الإستماع إلى السور المحملة فقط .");
