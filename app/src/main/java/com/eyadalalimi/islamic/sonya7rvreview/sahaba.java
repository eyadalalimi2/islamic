...
public class sahaba extends AppCompatActivity {
    Typeface typeface;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anbiya);
        final String saha="sahaba";
        ...
        txt.setText(getString(R.string.qissassahaba));
        txt.setTypeface(typeface);
        String[] items =getResources().getStringArray(R.array.sahaba);
        ...
        ls.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent lire=new Intent(sahaba.this,Lire_stories.class);
                lire.putExtra("pos",position);
                lire.putExtra("a2",saha);
                startActivity(lire);
            }
        });
    }
