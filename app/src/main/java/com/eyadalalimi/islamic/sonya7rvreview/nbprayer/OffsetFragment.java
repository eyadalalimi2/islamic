...
import com.eyadalalimi.islamic.sonya7rvreview.nbprayer.preferences.PrayerOffsetPreferenceDialogFragment;
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        ...
        if (key.contains(getString(R.string.pref_time_offset_key))) {
            ...
            switch (Integer.parseInt(key.substring(preference.getKey().length() - 1))) {
                case 0:
                    prayerOffsetPreferenceDialogFragment = PrayerOffsetPreferenceDialogFragment.newInstance(key, prayers.get(0));
                    break;
                case 1:
                    prayerOffsetPreferenceDialogFragment = PrayerOffsetPreferenceDialogFragment.newInstance(key, prayers.get(1));
                    break;
                case 2:
                    prayerOffsetPreferenceDialogFragment = PrayerOffsetPreferenceDialogFragment.newInstance(key, prayers.get(2));
                    break;
                case 3:
                    prayerOffsetPreferenceDialogFragment = PrayerOffsetPreferenceDialogFragment.newInstance(key, prayers.get(3));
                    break;
                case 4:
                    prayerOffsetPreferenceDialogFragment = PrayerOffsetPreferenceDialogFragment.newInstance(key, prayers.get(5));
                    break;
                case 5:
                    prayerOffsetPreferenceDialogFragment = PrayerOffsetPreferenceDialogFragment.newInstance(key, prayers.get(6));
                    break;
            }
