...
public class PrayTime {
    ...
    private final ArrayList<String> timeArNames;
    ...
    public PrayTime() {
        ...
        // Time Names
        timeArNames = new ArrayList<String>();
        timeArNames.add("الفجر");
        timeArNames.add("الشروق");
        timeArNames.add("الظهر");
        timeArNames.add("العصر");
        timeArNames.add("الغروب");
        timeArNames.add("المغرب");
        timeArNames.add("العشاء");
    ...
    public static void runApp() {
        double latitude = 31.5353;
        double longitude = 34.53579;
        double timezone = 3;
        ...
        for (int i = 0; i < prayerTimes.size(); i++) {
            Log.d("Prayer_Log", "prayerName: " + prayerNames.get(i) + " - " + prayerTimes.get(i));
        }

        Log.d("Prayer_Log", "initTimes: ");
    }

    public static double getDefaultTimeZoneDouble() {
        return getTimeZoneDouble(TimeZone.getDefault());
    }

    public static double getTimeZoneDouble(Context context) {
        return getTimeZoneDouble(TimeZone.getTimeZone(PreferenceUtil.getTimezonePref(context)));
    }

    public static double getTimeZoneDouble(TimeZone tz) {
        return tz.getOffset(new Date().getTime()) / 3600000.0;
    }
    ...
    // -------------------- Interface Functions --------------------
    // return salatiii times for a given date
    ...
    // compute salatiii times at given julian date
    ...
    // adjust times in a salatiii time array
    ...
    public ArrayList<String> getTimeArNames() {
        return timeArNames;
    }
}
