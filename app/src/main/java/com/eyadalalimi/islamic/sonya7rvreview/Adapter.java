...
import com.eyadalalimi.islamic.sonya7rvreview.Adapter.Item;
...
class Adapter extends ArrayAdapter<Item> {
    ...
    public View getView(int pos, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vh.arabicImg = convertView.findViewById(R.id.arabicImg);
            vh.arabic = convertView.findViewById(R.id.arabicTxt);
            vh.meaning = convertView.findViewById(R.id.meaning);
